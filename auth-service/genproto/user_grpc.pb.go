...
type UserServiceClient interface {
	...
	GetByIdUser(ctx context.Context, in *IdRequest, opts ...grpc.CallOption) (*User, error)
...
func (c *userServiceClient) GetByIdUser(ctx context.Context, in *IdRequest, opts ...grpc.CallOption) (*User, error) {
	out := new(User)
...
type UserServiceServer interface {
	...
	GetByIdUser(context.Context, *IdRequest) (*User, error)
...
func (UnimplementedUserServiceServer) GetByIdUser(context.Context, *IdRequest) (*User, error) {
